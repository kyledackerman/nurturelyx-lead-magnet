...
const HeroWithForm = ({
  ...
  return (
    <section className="relative bg-black py-12 md:py-16 overflow-hidden" data-form-section="true">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-start max-w-7xl mx-auto">
          ...
          <div className="space-y-6 lg:space-y-8">
            ...
            <div className="relative animate-fade-in">
              <h1 className="text-3xl md:text-5xl lg:text-6xl font-bold tracking-tight text-foreground relative">
                Your Website Is Leaking
                <span className="block text-transparent bg-gradient-to-r from-red-500 to-red-400 bg-clip-text">
                  Cash.
                </span>
              </h1>
              <div className="absolute -top-2 -right-2 lg:-top-4 lg:-right-4 text-red-500">
                <TrendingDown className="w-6 h-6 md:w-8 md:h-8 lg:w-12 lg:h-12 animate-pulse" />
              </div>
            </div>
            
            <h2 className="text-xl md:text-2xl lg:text-3xl font-semibold text-gray-300 animate-fade-in animation-delay-200">
              What if you could find out—in 2 minutes—exactly how much?
            </h2>
            
            <p className="text-lg md:text-xl text-accent font-medium animate-fade-in animation-delay-300">
            ...
            <p className="text-lg md:text-xl font-semibold text-red-500 animate-fade-in animation-delay-500">
