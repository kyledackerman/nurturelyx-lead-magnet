  ...
  return (
    <Tabs defaultValue="overview" className="w-full">
      <TabsList className="grid w-full grid-cols-2">
        <TabsTrigger value="overview" className="text-white">Domain Overview</TabsTrigger>
        <TabsTrigger value="solution" className="text-white">NurturelyX Solution</TabsTrigger>
      </TabsList>
