  ...
  return (
    <Card className="stat-card border-l-4 border-l-accent overflow-hidden bg-secondary p-6">
      <div className="flex justify-between items-start">
        <div>
          <p className="stat-label text-white text-sm font-semibold uppercase tracking-wider">{label}</p>
          <h3 className="stat-value text-4xl md:text-5xl font-extrabold mt-2 text-accent">{value}</h3>
          <p 
