      ...
      <Table className="w-full">
        <TableHeader>
          <TableRow className="bg-secondary-foreground/5">
            ...
            <TableHead className="text-right text-white">Missed Leads</TableHead>
            <TableHead className="text-right text-white">Lost Sales</TableHead>
            <TableHead className="text-right text-white">Lost Revenue</TableHead>
          </TableRow>
        </TableHeader>
        <TableBody>
          {data.map((month, index) => (
            <TableRow key={index} className={index % 2 === 0 ? "bg-secondary-foreground/5" : ""}>
              ...
              <TableCell className="text-right text-white">{month.visitors.toLocaleString()}</TableCell>
              <TableCell className="text-right text-white">{(month.missedLeads || month.leads).toLocaleString()}</TableCell>
              <TableCell className="text-right text-white">{(month.lostSales || month.sales).toLocaleString()}</TableCell>
