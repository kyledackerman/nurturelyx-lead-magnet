-- Drop all existing versions of get_crm_prospects_with_stats to resolve conflicts
DROP FUNCTION IF EXISTS public.get_crm_prospects_with_stats(text[], uuid, integer, integer);
DROP FUNCTION IF EXISTS public.get_crm_prospects_with_stats(text[], uuid, text, integer, integer);
DROP FUNCTION IF EXISTS public.get_crm_prospects_with_stats(text[], uuid, text, text, integer, integer);

-- Recreate the correct version with 6 parameters
