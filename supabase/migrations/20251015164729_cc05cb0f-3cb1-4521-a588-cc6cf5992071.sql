-- Update get_crm_prospects_with_stats to show ALL prospects without emails (not just review/enriched)
  ...
  WHERE 
    ...
    AND (
      ...
      (p_view = 'missing-emails' AND 
        pa.status NOT IN ('closed_won', 'closed_lost', 'not_viable') AND 
        EXISTS (
